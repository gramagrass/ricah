...
const About: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setRandomImage(`https://0fuqq7uksetsgrwn.public.blob.vercel-storage.com/ricah${randomNum}.jpg`);
    ...
    <div className="max-w-[1080px] mx-auto py-5 px-4 sm:px-6 lg:px-8">
      ...
      {randomImage && (
        <img
          ...
          className="w-full max-w-[1080px] mx-auto h-auto object-contain mb-4 sm:w-screen sm:max-w-none"
        />
      )}
